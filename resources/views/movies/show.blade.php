            ...
            <div class="md:ml-24">
                ...
                <div x-data="{isOpen: false}">
                    ...
                    <div class="mt-12">
                        <button 
                        @click="isOpen = true"
                        href="https://youtube.com/watch?v={{ $movie['videos']['results'][0]['key'] }}"target="_blank" class="flex items-center bg-orange-500 text-gray-900 rounded font-semibold px-5
                    ...
                    <div 
                        ...
                        class="fixed top-0 left-0 w-full h-full flex items-center shadow-lg overflow-y-auto rounded-lg " x-show.transition.opacity="isOpen"  >
