...
@section('content')
    ...
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 pb-16 pt-28 flex flex-col md:flex-row ">
            <img src="{{ $movie['poster_path'] }}"  class="w-64 lg:w-96 rounded-lg mx-auto" style="width: 22rem"  alt="">
            <div class="md:ml-24">
                <h2 class="text-4xl font-semibold pt-4 lg:pt-0 md:pt-0">{{ $movie['title'] }}</h2>
                ...
                <div x-data="{isOpen: false}">
                    @if(count($movie['videos']['results']) > 0)
                        <div class="mt-12">
                            <button 
                            @click="isOpen = true"
                            href="https://youtube.com/watch?v={{ $movie['videos']['results'][0]['key'] }}"target="_blank" class="flex items-center bg-yellow-500 text-gray-900 rounded font-semibold px-5
                        ...
                        <div 
                            ...
                            class="fixed top-0 left-0 w-full h-full flex items-center shadow-lg overflow-y-auto rounded-lg z-10" x-show.transition.opacity="isOpen" >
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">         
                @foreach ($movie['images'] as $image)
                    <div class="mt-8">
                        ...
                        "
                        >
                            <img src="{{ 'https://image.tmdb.org/t/p/w500'.$image['file_path'] }}" alt="image1" class="hover:opacity-75 transition ease-in-out duration-150 h-64 w-full object-cover rounded">
                        </a>
                    </div>
                @endforeach
            </div>
