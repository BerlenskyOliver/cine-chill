<div class="max-w-md mx-auto bg-gray-900 rounded-xl shadow-md overflow-hidden md:max-w-2xl my-3">
    <a href={{ $url }}>
      ...
      <div class="p-4">
        ...
        <a href={{ $url }} class="block mt-1 text-lg leading-tight font-medium text-white hover:underline">{{ $result['name'] }}</a>
