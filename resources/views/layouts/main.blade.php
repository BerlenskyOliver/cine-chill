...
<body class="font-sans bg-gray-900 text-white">
    <nav class="border-b border-gray-800">
        <div class="container px-4 mx-auto flex flex-col md:flex-row item-center justify-between px-4 py-6">
            <ul class="flex flex-col md:flex-row items-center">
                ...
                <li class="md:ml-16 mt-3 md:mt-0"> 
                    <a href="{{ route('movies.index') }}" class="hovr:text-gray-300">Movies</a>
                </li>
                <li class="md:ml-6 mt-3 md:mt-0"> 
                    <a href="{{ route('tv.index') }}" class="hovr:text-gray-300">Tv Shows</a>
                </li>
                <li class="md:ml-6 mt-3 md:mt-0"> 
                    <a href="{{ route('actors.index') }}" class="hovr:text-gray-300">Actors</a>
                </li>
            </ul>
